Assets = (function(){
	...
	return fiat.dom.fiat([{
		...
		icon_nut: function($NS$SVG, svg,g,path){
			var originalSize = 1000;
			function square(s){ return {width: s, height: s}; }
			...
			return function(size){
				...
				return svg.A(square(size))(
					g.scale(scale)(
						svg.A(square(originalSize))(path.a('d')(d))
					)
				);
			};
		},
		icon_bolt: function($NS$SVG, svg,g,path,polygon){
			var originalSize = 512;
			function square(s){ return {width: s, height: s}; }
			var points1="201.671,205.391 304.071,212.704 304.071,195.68  201.671,188.366";
			var points2="201.671,239.524 304.071,246.837 304.071,229.813 201.671,222.5";
			var points3="201.671,273.657 304.071,280.97  304.071,263.946 201.671,256.633";
			var points4="201.671,307.79  304.071,315.104 304.071,298.08  201.671,290.767";
			var points5="201.671,341.924 304.071,349.237 304.071,332.213 201.671,324.9";
			var points6="201.671,376.057 304.071,383.37  304.071,366.346 201.671,359.033";
			var points7="201.671,410.193 304.071,417.506 304.071,400.482 201.671,393.169";
			var d1 = "M379.363,10.786C376.385,4.13,370.019,0,362.766,0h-83.627c-3.063,0-5.897,1.647-7.407,4.301l-7.296,12.766h-24.235 l-7.287-12.766C231.395,1.647,228.571,0,225.507,0h-76.39c-6.835,0-13.005,3.772-16.094,9.839 c-3.14,6.161-2.551,13.483,1.545,19.115c10.411,14.345,25.088,26.658,39.211,38.05c17.468,14.08,27.895,36.821,27.895,60.834 v43.418l102.4,7.313v-50.731c0-24.013,10.419-46.754,27.887-60.834c3.413-2.748,7.339-5.675,11.494-8.781 c11.059-8.26,23.595-17.621,32.981-28.169C381.181,24.721,382.307,17.34,379.363,10.786z";
			var d2 = "M201.671,452.272c0,1.997,0.7,3.925,1.971,5.461l42.667,51.2c1.63,1.946,4.028,3.072,6.562,3.072 c2.534,0,4.932-1.126,6.562-3.072l42.667-51.2c1.271-1.536,1.971-3.464,1.971-5.461v-17.655l-102.4-7.313V452.272z";
			return function(height){
				var scale = height/originalSize;
				var width = Math.ceil((252/512)*height);
				return svg.A({width: width, height: height})(
					g.scale(scale)(
						svg.A({width: 252, height: 512})(g.translate(-130,0)(
							polygon.A({points:points1}),
							polygon.A({points:points2}),
							polygon.A({points:points3}),
							polygon.A({points:points4}),
							polygon.A({points:points5}),
							polygon.A({points:points6}),
							polygon.A({points:points7}),
							path.A({d:d1}),path.A({d:d2})
						))
					)
				);
			};
		},
		icon_house: function($NS$SVG, svg,g,path){
			var originalSize = 50;
			function square(s){ return {width: s, height: s}; }
			var vars = {a:10,b:6,c:16,d:30,e:21,x:10,y:48};
			return function(size){
				var scale = size/originalSize;
				return svg.A(square(size))(
					g.scale(scale)(
						svg.A(square(originalSize))(
							path.dxy().vars(vars).x('x','a.a.a.bEEb.').y('y','.C.c.C.Dd.c').z()().A({fill:'black',stroke:'none'})
						)
					)
				);
			};
